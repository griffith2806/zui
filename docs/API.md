...
pub const Event = union(enum) {
    ...
    focus_gained:  void,
    focus_lost:    void,
    drag_enter:    DragPayload,   // object entered window; preview of what will be dropped
    drag_over:     DragPosition,  // drag cursor moved while hovering
    drag_leave:    void,          // drag left without a drop
    drop:          DragPayload,   // user completed a drop into the window
};
